...
/* Guarda un separador como un token en la lista de tokens. */
...
/* Guarda una palabra como un token en la lista de tokens. */
...
/* Verifica si un carácter en una posición específica es un 
separador. */
...
/* Cambia el estado actual según el carácter encontrado 
...
/* Guarda una palabra o separador en la lista de tokens, 
