...
/* Valida los argumentos iniciales y configura el modo de 
ejecución (interactivo o no). */
...
/* Maneja el modo interactivo del shell, permitiendo 
comandos continuos hasta salir. */
...
/* Ejecuta comandos en modo no interactivo, procesando la 
...
/* Punto de entrada del programa: inicializa datos, selecciona 
modo y ejecuta comandos. */
